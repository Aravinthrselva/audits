...
|:-------------------------|:-----------|:-----------|:---------|:----------|
| [DRE App - dreUSD](https://audits.sherlock.xyz/contests/1259) |   Jun 2026  |   4L | No HMs in scope  | stablecoin protocol, backed by cash & cash equivalents, property & real estate credit, and short-duration secured loans,  ERC-20 token, ERC-4626 vault, rewards distribution logic, and Layer Zero OFT adapters    |
| [K2](https://code4rena.com/audits/2026-04-k2) |   May 2026  |   5H 1M | 🥈 2nd  | Lending Market, Stellar/Soroban    |
| [Flying Tulip](https://audits.sherlock.xyz/contests/1223) | Jan 2026 | 1L | No HMs in scope | Sale token upside exposure with downside protection |
| [Index.Fun OrderBook](https://audits.sherlock.xyz/contests/1197) |   Oct 2025  |   1H | 13th | Orderbook Prediction market - Polymarket inspired    |
...
| [PinLink](https://audits.sherlock.xyz/contests/852) | Mar 2025 | _ | No HMs in scope | RWA-Tokenized DePIN Marketplace  |
...
**Advanced Solidity: Understanding and Optimizing Gas Costs — [Jeffrey Scholz](https://x.com/Jeyffre)**
- Deep dive into the Solidity compiler and EVM internals  
- Understanding how memory, transaction data, state changes, and computational costs affect gas usage  
- Common design patterns and pitfalls to avoid

**Cyfrin Updrafts**
- Completed the Smart Contract Security Course 
- Built and tested a custom stablecoin protocol using Foundry
- Protocol analysis: Uniswap V2, V3, V4, Rocket Pool, Aave V3, GMX Perpetuals and more 

**Alchemy University — Ethereum Developer Bootcamp**
- Blockchain cryptography and consensus mechanisms  
- Ethereum data structures and Merkle Trees  
